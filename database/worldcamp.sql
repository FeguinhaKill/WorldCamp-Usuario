...
-- Copiando dados para a tabela worldcamp.agendardormitorio: ~7 rows (aproximadamente)
INSERT INTO `agendardormitorio` (`Id`, `nome-usuario`, `check-in`, `check-out`, `dormitorio`) VALUES
	...
	(6, 'Milena', '2025-12-02', '2025-12-04', 2),
	(7, 'Milena', '2025-12-03', '2025-12-05', 67),
	(8, 'ASDBFGHJVerhbtjnm', '2025-12-10', '2025-12-12', 1234),
	(10, 'Milena', '2025-12-11', '2025-12-12', 2);
...
-- Copiando dados para a tabela worldcamp.agendartrilhas: ~7 rows (aproximadamente)
...
-- Copiando dados para a tabela worldcamp.compras_realizadas: ~9 rows (aproximadamente)
INSERT INTO `compras_realizadas` (`id`, `nome_usuario`, `produtos_json`, `data_compra`) VALUES
	...
	(10, 'Alanbidanos', '[{"nome":"Camiseta Personalizada WorldCamp","preco":89.9,"quantidade":6},{"nome":"Kit Aleatório WorldCamp","preco":"159.00","quantidade":7}]', '2025-11-19 13:35:27'),
	(16, 'Felipe', '[{"nome":"Botas de Chuva Impermeáveis","preco":"249.00","quantidade":1},{"nome":"Jaqueta School WorldCamp","preco":"329.00","quantidade":67}]', '2025-11-26 15:45:06'),
	(17, 'Milena Zang', '[{"nome":"Garrafa Térmica WorldCamp","preco":"119.00","quantidade":1}]', '2025-12-02 19:04:36'),
	(18, 'Felipe', '[{"nome":"Botas de Chuva Impermeáveis","preco":"249.00","quantidade":1},{"nome":"Garrafa Térmica WorldCamp","preco":"119.00","quantidade":1}]', '2025-12-03 13:03:40'),
	(19, 'Felipe', '[{"nome":"Garrafa Térmica WorldCamp","preco":"119.00","quantidade":1}]', '2025-12-03 15:50:03'),
	(20, 'Alanbidanos', '[{"nome":"Botas de Chuva Impermeáveis","preco":"249.00","quantidade":4}]', '2025-12-10 14:43:42');
...
-- Copiando dados para a tabela worldcamp.usuarios: ~6 rows (aproximadamente)
INSERT INTO `usuarios` (`Id`, `nome`, `email`, `cpf`, `telefone`, `senha`) VALUES
	...
	(7, 'senger', 'arthur@gmail.com', '123-456-789-00', '49998041402', '123r'),
	(8, 'qwert', 'feguinhak2@gmail.com', 'ergfvd', '49998041402', '12345');
