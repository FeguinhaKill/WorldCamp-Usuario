...
-- Copiando dados para a tabela worldcamp.agendardormitorio: ~3 rows (aproximadamente)
...
-- Copiando dados para a tabela worldcamp.agendartrilhas: ~6 rows (aproximadamente)
...
-- Copiando dados para a tabela worldcamp.usuarios: ~3 rows (aproximadamente)
